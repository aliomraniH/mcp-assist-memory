...
multi-agent and multi-surface work. One FastAPI process serves a **25-tool MCP**
...
- **25-tool MCP** over Streamable HTTP (memory, handoff, session, artifact,
...
with the full **25-tool** surface, plus the guard rails (no/bad token ⇒ 401,
