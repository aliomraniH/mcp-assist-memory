...
multi-agent and multi-surface work. One FastAPI process serves a **26-tool MCP**
...
- **26-tool MCP** over Streamable HTTP (memory, handoff, session, artifact,
...
with the full **26-tool** surface, plus the guard rails (no/bad token ⇒ 401,
